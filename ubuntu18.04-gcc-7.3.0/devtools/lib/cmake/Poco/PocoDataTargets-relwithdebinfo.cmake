...
set_target_properties(Poco::Data PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoData.so.61"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoData.so.61"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Data )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Data "${_IMPORT_PREFIX}/lib/libPocoData.so.61" )
