...
public:
    ...
    {
        return _makePromiseOutgoing<::std::shared_ptr<SessionPrx>>(true, this, &RouterPrx::_iceI_createSession, userId, password, context).get();
    }
    ...
    {
        return _makePromiseOutgoing<::std::shared_ptr<SessionPrx>, P>(false, this, &RouterPrx::_iceI_createSession, userId, password, context);
    }
    ...
    createSessionAsync(const ::std::string& userId, const ::std::string& password,
                       ...
                       const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::shared_ptr<SessionPrx>>(response, ex, sent, this, &Glacier2::RouterPrx::_iceI_createSession, userId, password, context);
    }

    /// \cond INTERNAL
    ICE_MEMBER(GLACIER2_API) void _iceI_createSession(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<SessionPrx>>>&, const ::std::string&, const ::std::string&, const ::Ice::Context&);
    /// \endcond
    ...
    {
        return _makePromiseOutgoing<::std::shared_ptr<SessionPrx>>(true, this, &RouterPrx::_iceI_createSessionFromSecureConnection, context).get();
    }
    ...
    auto createSessionFromSecureConnectionAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::std::shared_ptr<SessionPrx>>>().get_future())
    {
        return _makePromiseOutgoing<::std::shared_ptr<SessionPrx>, P>(false, this, &RouterPrx::_iceI_createSessionFromSecureConnection, context);
    }
    ...
    createSessionFromSecureConnectionAsync(::std::function<void(::std::shared_ptr<SessionPrx>)> response,
                                           ...
                                           const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::std::shared_ptr<SessionPrx>>(response, ex, sent, this, &Glacier2::RouterPrx::_iceI_createSessionFromSecureConnection, context);
    }

    /// \cond INTERNAL
    ICE_MEMBER(GLACIER2_API) void _iceI_createSessionFromSecureConnection(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<SessionPrx>>>&, const ::Ice::Context&);
    /// \endcond
